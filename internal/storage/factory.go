...
func Inicializar(driver, dsn, rutaDB, backend string) (*Recursos, error) {
	...
	if err := gdb.AutoMigrate(
		&viviendaModels.Vivienda{},         // Viviendas
		&viviendaModels.Foto{},             // Fotos
		&viviendaModels.AplicarVivienda{},  // AplicarViviendas
		&viviendaModels.Sector{},           // Sectores
		&alimentacionModels.Alimentacion{}, // Alimentacion
		&alimentacionModels.MenuDiario{},   // MenuDiario
		&alimentacionModels.Plato{},        // Platos
		&alimentacionModels.Resena{},       // Resenas
		&transporteModels.Cooperativa{},    // Cooperativas
		&transporteModels.RutaTransporte{}, // Rutas
		&transporteModels.ParadaBus{},      // Paradas
		&usuarioModels.Usuario{},           // Usuarios
	); err != nil {
		return nil, fmt.Errorf("AutoMigrate GORM: %w", err)
	}
